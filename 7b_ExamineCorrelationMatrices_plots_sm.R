...
## 23 December 2020: created for smoothed data
##############################################
...
allmb.cor.srt = alldat$allmb.sm.cor.srt  ##Contains communities sorted so that subcortical is first and uncertain last
allmb.gg.srt = alldat$allmb.sm.gg.srt
allmb.sd.srt = alldat$allmb.sm.sdsd.srt

allmb_tf.cor.srt = alldat_tf$allmb.tf.sm.cor.srt
allmb_tf.gg.srt = alldat_tf$allmb.tf.sm.gg.srt
allmb_tf.sd.srt = alldat_tf$allmb.tf.sm.sdsd.srt
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/ZCorr_9p_notf_tf_sm.png',width=14,height=12,units='in',res=1000)
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/ZCorr_subcort_cereb_9p_notf_tf_sm.png',width=14,height=12,units='in',res=1000)
par(mfrow=c(3,3),mar=c(4,7,3,2),oma=c(0,0,0,1))
for(i in 1:9) {
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/CohensD_9p_notf_tf_sm.png',width=14,height=12,units='in',res=1000)
par(mfrow=c(3,3),mar=c(4,7,3,2),oma=c(0,0,0,1))
for (i in 1:9) {
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/CohensD_subcort_cereb_9p_notf_tf_sm.png',width=14,height=12,units='in',res=1000)
par(mfrow=c(3,3),mar=c(4,7,3,2),oma=c(0,0,0,1))
for (i in 1:9) {
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/All16_FixedCoords_AttenuatedCorrelations_9p_3-4ratio_sm.png',width=16,height=12,units='in',res=500)
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/All16_FixedCoords_AttenuatedCorrelations_9p_FreeRatio_sm.png',width=14,height=12,units='in',res=500)
ggarrange(sp_33, sp_tf33, sp_2, sp_tf2, sp_3, sp_tf3, sp_4, sp_tf4, sp_6, sp_tf6, sp_8, sp_tf8, sp_9, sp_tf9, sp_12, sp_tf12,
          ncol = 2, nrow = 8 )
dev.off()
...
gg1 = ggplot(data = prop_sig_notf_long[prop_sig_notf_long$Community!="Uncertain",], aes(x=Community, y=Proportion, fill=Acquisition))+geom_bar(stat='identity',pos='dodge',colour='darkslategrey')+ylab('Proportion Edges Activated')+ylim(c(0,0.3))+ggtitle("A) 9p")+theme(axis.text=element_text(size=12))+scale_fill_brewer(palette="Paired")

gg2 = ggplot(data = prop_sig_tf_long[prop_sig_tf_long$Community!="Uncertain",], aes(x=Community, y=Proportion, fill=Acquisition))+geom_bar(stat='identity',pos='dodge',colour='darkslategrey')+ylab('Proportion Edges Activated')+ylim(c(0,0.3))+ggtitle("B) 9p+bandpass")+theme(axis.text=element_text(size=12))+scale_fill_brewer(palette = "Paired")

png(file='./OptimalSMS_rsfMRI/Documents/Figures/ProportionActivated_bonf_sm.png',width=14,height=12,units='in',res=500)
...
png(file='./OptimalSMS_rsfMRI/Documents/Figures/MeanCohensD_sm.png',width=14,height=12,units='in',res=500)
ggarrange(gg1, gg2, nrow=2 )
dev.off()


save(somemb.z.cor.srt,somemb_tf.z.cor.srt,someLabelsLong,varnames,prop_sig_tf,prop_sig_notf,cd_notf,cd_tf,file='~/risk_share/OptimalSMS_rsfMRI/Results/somemb.z.cor.srt.sm.RData')
